# credit to the pokemon showdown github repo for the original typescript file
# https://github.com/smogon/pokemon-showdown
# TODO implement this into the main code so that the players can use any pokemon
